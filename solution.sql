...
VALUES ('Oscar T G', 'TrashCan', 7, 10, 100, 13);

-- 10.The bank is losing money in Miami and Phoenix
-- and needs to unload low transaction customers: Delete users that reside 
-- in miami OR  phoenix and have completed fewer than 5 transactions.
DELETE FROM syntax_practice WHERE city IN ('miami', 'pheonix') AND transactions_completed < 5;